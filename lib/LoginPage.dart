...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    switch(_loginStatus){
      ...
      return new Scaffold(
        body: Form(key: _key,autovalidate: _autovalidadate,
        child: ListView(padding: EdgeInsets.only(top: 90.0,left: 20.0,right: 20.0),
        children: <Widget>[Image.asset('assets/logo_m2v.png', height: 60, width: 60),
        Text("Helpdesk Apps", textAlign: TextAlign.center,textScaleFactor: 1.2,),
        TextFormField(
          validator: (e){
          if(e!.isEmpty){
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            labelText: "Password",
            suffixIcon: IconButton(icon: Icon(_secureText ? Icons.visibility_off : Icons.visibility),onPressed: showHide)),
        ),
        MaterialButton(
